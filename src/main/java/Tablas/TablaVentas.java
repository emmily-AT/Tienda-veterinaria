...
public class TablaVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id venta", "Fecha", "Total venta", "Cliente ", "Vendedor ", "Mascota ", "Accesorios"
            }
        ) {
    ...
    public void llenarTabla(){
        ...
        for(VentaDto venta : ventas){
            for(MascotaDto mascota : venta.getMascotas()){
                String[] fila = {venta.getIdVenta(), venta.getFechaHora(), String.valueOf(venta.getValorVenta()), String.valueOf(venta.getCliente().toString()),
                String.valueOf(venta.getVendedor().toString()),String.valueOf(mascota.getNombre()) + " - " + String.valueOf(mascota.getId()) + " - " + String.valueOf(mascota.getTipo()) 
                        + " - " +String.valueOf(mascota.getPrecio()), String.valueOf(venta.getDetalles())};
                modelo.addRow(fila);
            }
        }
    }
